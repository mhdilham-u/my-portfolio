  ...
  const dataProject = [
    {
      ...
      linkStudyCase: "/",
      linkLivePreview: "pras-next.vercel.app",
      tag1: "#paragraph",
      tag2: "#react",
      tag3: "#nextjs",
      tag4: "#tailwindcss",
      imgProject: "/project-1.jpg",
    },
    {
      ...
      <div className="container m-auto">
        ...
        <section>
          <div className="flex flex-col justify-center items-center text-center">
            <Image className="rounded-full" src={"/profile.jpg"} width={120} height={120} alt="Profile Picture" />
            ...
            <ul className="flex text-paragraph gap-6 mt-5">
              <li>
                <Link href="https://github.com/mhdilham-u" target="_blank">
              ...
              <li>
                <Link href="https://www.instagram.com/mhd.ilham_u" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 fill-paragraph" viewBox="0 0 24 24" width="24" height="24">
                    <path fill="none" d="M0 0h24v24H0z" />
              ...
              <div className="flex lg:flex-row flex-col-reverse items-center">
                <div className="text-paragraph lg:pr-4 pr-0 mx-1 lg:mx-0">
                  ...
                  <div className="flex lg:mb-10 mb-5 gap-6">
                    <Link href={linkStudyCase} className="flex gap-2 text-title items-center">
                    ...
                    <Link href={linkLivePreview} target="_blank" className="flex gap-2 text-title items-center">
